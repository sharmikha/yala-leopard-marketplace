...
describe("LeopardMarketplace", function () {
  ...
  describe("Leopard Registration", function () {
    ...
    it("should record the mint in ownership history", async function () {
      ...
      expect(history[0].transactionType).to.equal(
        0n
      );
    });
  });
...
// ============================================================
// LISTING, CANCELLATION, AND SECONDARY RESALE TESTS
// ============================================================
...
// ============================================================
// TRANSFER / GIFT AND CONSERVATION FUND TESTS
// ============================================================
...
describe("Read Functions", function () {
  it("should return all registered leopards", async function () {
    ...
    expect(leopards[0].tokenId).to.equal(1n);
    expect(leopards[0].leopardId).to.equal("YL-001");
    expect(leopards[0].name).to.equal("Natta");
    expect(leopards[0].price).to.equal(priceOne);

    expect(leopards[1].tokenId).to.equal(2n);
    expect(leopards[1].leopardId).to.equal("YL-002");
    expect(leopards[1].name).to.equal("Kuma");
    expect(leopards[1].price).to.equal(priceTwo);
  });
  ...
  it("should return the correct leopard by token ID", async function () {
    ...
    expect(leopard.leopardId).to.equal("YL-001");
    expect(leopard.name).to.equal("Natta");
    expect(leopard.territory).to.equal("Yala Block 1");
    expect(leopard.description).to.equal(
      "Adult male leopard"
    );
    expect(leopard.conservationStatus).to.equal(
